...
Then drive it with the `kresko` CLI::
    ...
    kresko run pyinfra_do_smoke --run-name regression-1 -- up
    kresko run pyinfra_do_smoke --run-name regression-1 -- deploy
    kresko run pyinfra_do_smoke --run-name regression-1 -- smoke
    kresko run pyinfra_do_smoke --run-name regression-1 -- collect
    kresko run pyinfra_do_smoke --run-name regression-1 -- down
